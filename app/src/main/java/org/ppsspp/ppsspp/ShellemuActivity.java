...
public class ShellemuActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.shellemu);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		_fab.setOnLongClickListener(new View.OnLongClickListener() {
			...
			public boolean onLongClick(View _view) {
				Shell.SU.run("su");
				boolean root = true;
				new RunCommandTask(root).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, edittext2.getText().toString());
				...
				java.lang.System.setOut(new java.io.PrintStream(new java.io.OutputStream() {
						...
						public void write(int oneByte) throws java.io.IOException {
								...
								edittext1.setText(new String(outputStream.toByteArray()));
						}
				}));
				return true;
			}
	...
	private void initializeLogic() {
		...
		edittext1.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/gow.ttf"), 1);
		edittext2.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/gow.ttf"), 1);
		  ...
		  public static class Console implements java.io.Closeable {
			    ...
			    Console(Builder builder) throws ShellNotFoundException {
				      try {
					        ...
					        ShellemuActivity aan = new ShellemuActivity();
	...
	private class RunCommandTask extends AsyncTask<String, Void, CommandResult> {
		...
		@Override protected void onPreExecute() {
			dialog = ProgressDialog.show(ShellemuActivity.this, "Running Command", "Please Wait...");
