...
public class Ninjacoder extends EditText
{
    private final Context context;
    private Rect rect;
    private Paint paint;

    public Ninjacoder(Context context)
    {
        super(context);
    ...
    public Ninjacoder(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        this.context = context;
        init();
    ...
    public Ninjacoder(Context context, AttributeSet attrs, int defStyle)
    {
